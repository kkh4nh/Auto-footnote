# Auto-footnote
Auto footnote for word

I use Anaconda Prompt to run the code
...
+ file word cần phải không có footnote sẵn nếu không sẽ lỗi
+ những phần bạn muốn footnote hãy đóng ngoặc đơn lại vd: (hi the world) thì nó sẽ chuyển cả bên trong ngoặc đơn thành footnote đồng thời sẽ xóa phần đấy ở phía trên 
+ nó sẽ auto dịch chuyển những nơi có ngoặc đơn ( , ) nên hãy chú ý không là có thể biến các dữ liệu khác thành footnote
